...
import { getAllCategories, getProductsByCategory } from './src/services/categoryApi.js';
...
export async function filterByCategory(option){
  try{
    const newList = getProductsByCategory(option);
